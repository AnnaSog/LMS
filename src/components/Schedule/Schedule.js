        ...
        <div className='schedule'>
          <table className="clmonth">
            ...
            <tr>
              ...
              <td> 
                {loading ? <div className='lessionPassed'> Loading...</div> : 
                    <div className='lessionPassed'> {lesson[0].nameLesson} <br/> {lesson[0].timeStart} : {lesson[0].timeEnd} <br/> {lesson[0].progress}% </div>
                }
              </td>
              <td> 
                {loading ? <div className='lessionPassed'> Loading...</div> : 
                    <div className='lessionPassed'> {lesson[3].nameLesson} <br/> {lesson[3].timeStart} : {lesson[3].timeEnd} <br/> {lesson[3].progress}%</div>
                }
              </td>
              <td className='col'></td>
              <td className='col'></td>
            ...
            <tr>
              ...
              <td> 
                {loading ? <div className='lessionPassed'> Loading...</div> : 
                    <div className='lessionPassed'> {lesson[1].nameLesson} <br/> {lesson[1].timeStart} : {lesson[1].timeEnd} <br/> {lesson[1].progress}%</div>
                }
              </td>
              <td> 
                {loading ? <div className='lessionPassed'> Loading...</div> : 
                    <div className='lessionPassed'> {lesson[4].nameLesson} <br/> {lesson[4].timeStart} : {lesson[4].timeEnd} <br/> {lesson[4].progress}%</div>
                }
              </td>
              <td className='col'></td>
              <td className='col'></td>
            ...
            <tr>
              ...
              <td> 
                {loading ? <div className='lessionPassed'> Loading...</div> : 
                    <div className='lessionPassed'> {lesson[2].nameLesson} <br/> {lesson[2].timeStart} : {lesson[2].timeEnd} <br/> {lesson[2].progress}% </div>
                }
              </td>
              <td className='col'></td>
              <td className='col'></td>
